...
const UvIndicator = ({uvIndex}) => {
  return <div className='{flex flex-col items-start gap-1}'>
    ...
    <div className={classNames(styles.line,'w-[115px] h-[5px] mt-[17px] rounded-xl relative bg-gradient-to-r-')}>
      <div className={'absolute w-3 h-3 bg-white rounded-full top-[-3px]'}
           style={{marginLeft: `${uvIndex*8.25}%`}}></div>
    </div>
  </div>
}
