...
import { useHorizontalScroll } from "../../hooks/useHorizontalScrollHook";
  ...
  return (
    <div className={"city-pagination flex gap-[21px] items-center"}>
      ...
      <img
        ...
        alt=""
        className={"cursor-pointer relative rotate-180"}
      />
    </div>
  );
};
  ...
  return (
    <section
      className={classNames(
        styles.container,
        "hours-weather__container col-start-1 col-end-3 row-start-4 row-end-5 flex flex-col items-center gap-12",
      )}
    >
      <div
        ref={scrollRef}
        className={classNames(
          styles.flipped,
          styles.scrollList,
          "max-w-[1720px] pb-[44px] overflow-x-scroll",
        )}
      >
        <ul
          className={classNames(
            styles.flipped,
            "flex gap-[55px] flipped w-[2660px]",
          )}
        >
